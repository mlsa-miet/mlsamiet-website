...
export default function Event() {
  const eventData = [
    ...
    },
     {
      ...
      {
      title: "Avsar 2.0",
      body: "AVSAR 2.0 is a flagship initiative of Microsoft Learn Student Ambassadors (MLSA) MIET, empowering students through structured learning, mentorship, and collaborative growth. Designed as a platform where innovation meets leadership, AVSAR encourages young minds to explore technology, build industry-relevant skills, and become confident professionals within a thriving tech community. AVSAR 2.0 – The Orientation marked an important milestone by welcoming new members and introducing first-year students to the vision of MLSA MIET. Featuring a keynote by Rohit Yadav on “How to Get Into Microsoft,” reflections by Kushagra (HOO, MLSA MIET), and an interactive quiz led by Avni, the event reflected MLSA MIET’s commitment to nurturing talent and enabling growth.",
